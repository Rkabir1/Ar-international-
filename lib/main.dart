  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          if (role == "admin")
            IconButton(
                ...
                onPressed: () => Navigator.push(context,
                    MaterialPageRoute(builder: (_) => const ManageAgents()))),
          IconButton(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (_, snap) {
          ...
          final docs = snap.data!.docs.where((d) {
            ...
            final matchS = m['name'].toString().toLowerCase().contains(search) ||
                m['passport'].toString().toLowerCase().contains(search);
            final matchA =
                selectedAgent == "All Agents" || m['agent'] == selectedAgent;
            return matchS && matchA;
          }).toList();

          double total = docs.fold(
              0, (sum, d) => sum + (d['payment'] ?? 0).toDouble());
                  ...
                  Expanded(
                      child: DropdownButtonFormField(
                          ...
                          items: agents
                              ...
                              .toList(),
                          onChanged: (v) =>
                              setState(() => selectedAgent = v.toString()))),
                  const SizedBox(width: 10),
                  Expanded(
                      child: TextField(
                          decoration: const InputDecoration(
                              labelText: "Search Passport/Name"),
                          onChanged: (v) =>
      ...
      floatingActionButton: FloatingActionButton(
          onPressed: () => addClientDialog(), child: const Icon(Icons.add)),
    );
  }
          ...
          content: SingleChildScrollView(
            child: Column(children: [
              ...
              DropdownButtonFormField(
                  ...
                  items: agents
                      .where((e) => e != "All Agents")
                      .map((e) =>
                          DropdownMenuItem(value: e, child: Text(e)))
                      .toList(),
                  onChanged: (v) => agent = v.toString()),
              ...
              onPressed: () async {
                ...
                if (img != null) {
                  final ref = FirebaseStorage.instance
                      .ref()
                      .child('docs/${DateTime.now().msSinceEpoch}');
  ...
  Future<void> printReceipt(Map<String, dynamic> d) async {
    ...
    pdf.addPage(pw.Page(
        build: (pw.Context context) => pw.Column(children: [
              pw.Center(
                  child: pw.Text("AR INTERNATIONAL",
                      style: pw.TextStyle(
              ...
              pw.Container(
                ...
                child: pw.Text("Total Amount Paid: BDT ${d['payment']}/-",
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => showDialog(
            ...
            builder: (_) => AlertDialog(
                  ...
                  content: TextField(
                      controller: c, decoration: const InputDecoration(hintText: "Name")),
                  actions: [
                    ElevatedButton(
                        onPressed: () {
